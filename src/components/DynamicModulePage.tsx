                    ...
                    >
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        <div>
                          ...
                          <h3 className="font-heading tabular-nums text-xl md:text-2xl font-bold text-black mb-4 line-clamp-2">
                            {item.title}
                          </h3>
                        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="font-heading tabular-nums text-xl md:text-2xl font-bold mt-2 text-black line-clamp-2">
                        {item.title}
                      </h3>
          ...
          {paginatedItems.map((item) => {
            ...
            if (module === "brochures") {
              return (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <h3 className="font-heading tabular-nums text-lg md:text-xl font-bold text-black mb-4 transition-colors group-hover:text-accent-red line-clamp-2">
                      {item.title}
                    </h3>
            ...
            return (
              ...
              >
                ...
                <div className="p-5">
                  <h3 className="font-heading tabular-nums text-lg md:text-xl font-bold text-black group-hover:text-accent-red transition-colors line-clamp-2">
                    {item.title}
                  </h3>
                  <p className="text-sm text-black/65 mt-2 line-clamp-3">
                    {item.short_description}
