...
export default function Footer() {
    ...
    return (
        <footer
            id="footer"
            className="scroll-section relative bg-black overflow-hidden border-t border-red-500/10 pt-16 pb-8 px-6 md:px-10"
        >
            {/* Glow */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="mt-16 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-5">
                    <p className="text-white/35 uppercase tracking-[0.25em] text-[11px] text-center">
                        © {new Date().getFullYear()} KAAVERI STEEL. ALL RIGHTS
                        RESERVED.
                    </p>
