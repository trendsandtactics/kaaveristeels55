...
export default function SteelCalculator() {
  ...
  return (
    <section className="relative w-full min-h-screen">
      ...
      {/* CONTENT */}
      <div className="relative z-10 flex items-center justify-end min-h-screen px-4 md:px-10">

        {/* CALCULATOR CARD */}
        <motion.div
          initial={{ opacity: 0, x: 80 }}
          animate={{ opacity: 1, x: 0 }}
          className="w-full max-w-xl bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden"
        >
