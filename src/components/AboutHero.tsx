...
export default function AboutHero() {
    return (
        <div className="w-full bg-white">
            ...
            <div className="w-full bg-gradient-to-r from-[#800000] via-[#a52a2a] to-[#5a0000] pt-32 pb-20 relative overflow-hidden shadow-sm">
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                    ...
                    <div className="text-center max-w-4xl mx-auto">
                        <h2 className="font-sans text-white uppercase tracking-[0.2em] font-bold text-sm mb-4">
                            About Us
                        </h2>
                        <h1 className="font-sans text-5xl md:text-7xl text-white mb-8 leading-tight drop-shadow-md">
                            Welcome to <span className="font-extrabold">KAAVERI</span><br />
                            <span className="font-extrabold text-4xl md:text-5xl block mt-2">
                                TMT & STRUCTURAL
                            </span>
                        </h1>
