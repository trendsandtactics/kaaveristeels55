...
export default function Home() {
  useEffect(() => {
    ...
    if (isTouchDevice || window.innerWidth < 1280 || window.innerHeight < 850) return;
  ...
  return (
    <div className="flex flex-col items-center w-full relative pt-20 md:pt-24">
      ...
      <section className="scroll-section scroll-mt-20 md:scroll-mt-24 w-full flex flex-col py-12 xl:py-0 xl:min-h-[calc(100svh-6rem)]">
        {/* Scrollytelling Hero Area */}
        <SteelScroll />
      </section>

      <section className="scroll-section scroll-mt-20 md:scroll-mt-24 w-full flex flex-col justify-center py-12 xl:py-0 xl:min-h-[calc(100svh-6rem)]">
        {/* About Section */}
        <HomeAbout />
      </section>
