...
export default function DealersPage() {
  ...
  return (
    <main className="flex flex-col min-h-screen w-full relative pt-20 overflow-hidden transition-colors duration-500">
        {/* Hero Section */}
        <div className="absolute top-0 left-0 w-full h-[320px] bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-400 -z-10" />
