...
export default function DealersPage() {
  ...
  return (
    <main className="flex flex-col min-h-screen w-full relative pt-20 bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-400 overflow-hidden transition-colors duration-500">
      {/* Hero Section */}
